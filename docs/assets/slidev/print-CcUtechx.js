import{d as _,_ as h,y as u,b as a,e as t,x as s,A as r,F as f,Z as v,o as n,$ as g,l as b,g as x}from"../modules/vue-DA7ZT_zT.js";import{e as y,h as N,c as m,b as k}from"../index-HiRLsQtH.js";import{N as w}from"./NoteDisplay-mcz-H2v0.js";import"../modules/shiki-CUMx7AeU.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},A={class:"opacity-50"},C=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-main mb-8"},M=_({__name:"print",setup($){const{slides:d,total:p}=y();h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
